...
function CalendarPanel(props) {
  ...
  useEffect(() => {
    let alive = true;
    api("status", {}).then((value) => { if (alive) setConfigured(value && value.configured !== false); })
  ...
  const body = () => {
    if (demo === false && configured === false) {
      return h("div", { className: "dshc-empty" }, [
        ...
        h("div", { style: { marginTop: "12px" } }, h(Btn, { variant: "primary", onClick: () => setDemo(true) }, t("action.demo")))
      ]);
    }
  ...
  return h("div", { className: "dshc-root" }, [
    h("div", { className: "dshc-shell" }, [
      ...
      h("div", { className: "dshc-footer" }, [
        ...
        h("span", null, demo === true ? t("demo.banner").slice(0, 0) : "")
      ])
    ]),
    selected !== null
      ? h(EventDrawer, {
